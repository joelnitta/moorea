...
raxmlHPC-AVX -y -m GTRCAT -p 12345 -s all_broad.aln.phy -n FullStartingTree

# compute 20 ML trees using reduced alignment, save the best one
raxmlHPC-PTHREADS -T 8 -m GTRGAMMA -p 12345 -# 20 -s all_broad.aln.phy.reduced -n all_broad_20ML
