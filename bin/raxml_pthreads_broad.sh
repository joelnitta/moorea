...
#SBATCH -t 14-0:00             # run for max 14 days
...
raxmlHPC-PTHREADS -T 16 -m GTRGAMMA -p 12345 -#20 -s ~/Analysis/moorea/bin/2015-12-02/examl/all_broad.phy -n all_broad_20ML
