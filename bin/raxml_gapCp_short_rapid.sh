...
# raxmlHPC-AVX -y -m GTRCAT -p 12345 -s ~/Analysis/moorea/data/gapCp_short.phy -n FullStartingTree

# Step 2:
# compute best ML tree (out of 20?) and 100 bootstraps in a single step
# choose either reduced alignment
# raxmlHPC -f a -m GTRGAMMA -p 12345 -x 12345 -# 100 -s ~/Analysis/moorea/data/gapCp_short.phy.reduced -n gapCp_short 
# or full
raxmlHPC -f a -m GTRGAMMA -p 12345 -x 12345 -# 100 -s ~/Analysis/moorea/data/gapCp_short.phy -n gapCp_short 
