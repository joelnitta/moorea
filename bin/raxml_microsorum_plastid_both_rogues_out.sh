...
raxmlHPC-PTHREADS -T 2 -f a -m GTRGAMMA -p 12345 -x 12345 -# 1000 -s ~/Analysis/moorea/data/microsorum_plastid_both_rogues_out.phy -n microsorum_plastid_both_rogues_out
